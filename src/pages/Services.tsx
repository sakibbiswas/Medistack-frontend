...
const Services: React.FC = () => {
  ...
  return (
    <div className={`relative min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-gray-100 px-6 md:px-16 z-10 ${hasSidebar ? "md:ml-64 pt-24" : "pt-12"}`}>
      ...
      {/* Main Service Cards */}
      <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16 relative z-10">
