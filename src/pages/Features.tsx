...
const Features: React.FC = () => {
  ...
  const features = [
    {
      ...
      title: "Secure Login",
      description: "Advanced authentication to keep your medical data safe and private.",
    },
    {
      icon: <FaCalendarAlt className="text-5xl text-teal-600 drop-shadow-md" />,
      title: "Easy Appointments",
      description: "Book, reschedule, and manage doctor visits with just a few clicks.",
    },
    {
    ...
    },
    {
      ...
      title: "24/7 Support",
      description: "Get round-the-clock assistance for any medical or technical queries.",
    },
  ];
  ...
  const services = [
    {
      ...
      description: "Comprehensive care for routine checkups and general health concerns.",
    },
    {
    ...
    },
    {
      ...
      name: "Dermatology",
      description: "Expert solutions for skin, hair, and cosmetic health issues.",
    },
    {
      icon: <FaClinicMedical className="text-5xl text-pink-600 drop-shadow-md" />,
      name: "Pediatrics",
      description: "Comprehensive healthcare services tailored for children and infants.",
    },
  ];
  ...
  const partners = ["Apollo Hospitals", "Square Hospital", "United Hospital", "LabAid Diagnostics"];
    ...
    <section className="relative overflow-hidden mt-8 px-6 md:px-16 py-20 animated-gradient">
      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
          <h2 className="text-5xl font-extrabold text-white drop-shadow-lg mb-12 animate-fadeIn">Why Choose Us?</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {features.map((feature, i) => (
              <div key={i} className="relative bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl p-8 text-center animated-card">
                <div className="flex items-center justify-center h-32 w-32 mx-auto mb-6 rounded-full bg-gradient-to-br from-blue-100 to-purple-100 shadow-inner">{feature.icon}</div>
        ...
        <div className="text-center mb-24">
          <h2 className="text-5xl font-extrabold text-white drop-shadow-lg mb-12 animate-fadeIn">Our Services</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {services.map((service, i) => (
              <div key={i} className="relative bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl p-8 text-center animated-card">
                <div className="flex items-center justify-center h-32 w-32 mx-auto mb-6 rounded-full bg-gradient-to-br from-green-100 to-pink-100 shadow-inner">{service.icon}</div>
        ...
        {/* How It Works */}
        <div className="text-center mb-24">
          <h2 className="text-5xl font-extrabold text-white drop-shadow-lg mb-12 animate-fadeIn">How It Works</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {steps.map((step, i) => (
              <div key={i} className="relative bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl p-8 text-center animated-card">
        ...
        {/* Achievements */}
        <div className="text-center mb-24">
          <h2 className="text-5xl font-extrabold text-white drop-shadow-lg mb-12 animate-fadeIn">Our Achievements</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {stats.map((s, i) => (
              <div key={i} className="relative bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl p-8 text-center animated-card">
        ...
        <div className="text-center">
          <h2 className="text-5xl font-extrabold text-white drop-shadow-lg mb-12 animate-fadeIn">Our Partners</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {partners.map((p, i) => (
              <div key={i} className="relative bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl p-8 text-center animated-card">
