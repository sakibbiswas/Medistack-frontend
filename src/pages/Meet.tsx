...
const Meet: React.FC = () => {
  ...
  const doctors = [
    {
      ...
      icon: <FaHeartbeat className="text-5xl text-pink-500 drop-shadow-md" />,
    },
    {
    ...
    },
    {
      ...
      icon: <FaStethoscope className="text-5xl text-green-500 drop-shadow-md" />,
    },
    {
  ...
  const testimonials = [
    { text: "MediStack++ made booking appointments so easy and hassle-free!", patient: "Emily Parker" },
    { text: "The platform is intuitive and saves me a lot of time managing appointments.", patient: "Robert Wilson" },
    { text: "I love how secure and user-friendly the system is. Highly recommended!", patient: "Sophia Martinez" },
    { text: "Thanks to MediStack++, I can connect with top doctors anytime.", patient: "Daniel Thompson" },
  ];

  const pricing = [
    { plan: "Free", price: "$0/month", description: "Basic access to our platform" },
    { plan: "Pro", price: "$9.99/month", description: "Advanced features for regular users" },
    { plan: "Premium", price: "$19.99/month", description: "Exclusive features and faster support" },
    { plan: "Enterprise", price: "Custom Pricing", description: "Tailored solutions for organizations" },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {doctors.map((doc, i) => (
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-1 text-gray-800">{doc.name}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {testimonials.map((t, i) => (
              ...
              >
                ...
                <p className="font-semibold text-gray-800 text-right">- {t.patient}</p>
              </blockquote>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {pricing.map((p, i) => (
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-2 text-gray-800">{p.plan}</h3>
                <p className="text-purple-600 font-extrabold text-3xl mb-2">{p.price}</p>
