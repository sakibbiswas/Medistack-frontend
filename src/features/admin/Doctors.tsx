...
//   const handleRemoveSlot = (slot: string) => setSlots(slots.filter((s) => s !== slot));
...
//       setForm({ name: "", email: "", password: "", specialization: "", departmentId: "" });
//       setSlots([]);
//     } catch (err: any) {
...
//   // --- Components ---
//   const SlotBadge = ({ slot, onRemove }: { slot: string; onRemove?: (slot: string) => void }) => (
...
//         <p className="text-gray-500 text-sm">{doctor.email} • {doctor.specialization}</p>
//         <p className="text-gray-500 text-sm">
//           Dept: {typeof doctor.departmentId === "object" ? doctor.departmentId.name : doctor.departmentId || "N/A"}
//         </p>
...
//           onClick={() => {
//             if (confirm("Are you sure you want to delete this doctor?")) deleteDoctor(doctor._id);
//           }}
//         >
//           Delete
//         </button>
...
//       <main className="flex-1 ml-64 p-6 pt-20 relative z-10">
...
//               </button>
//             </div>
//             <div className="flex flex-wrap gap-2">{slots.map((s) => <SlotBadge key={s} slot={s} onRemove={handleRemoveSlot} />)}</div>
//           </div>
...
//               </button>
//             </div>
//             <div className="flex flex-wrap gap-2 mb-3">{editSlots.map((s) => <SlotBadge key={s} slot={s} onRemove={handleRemoveEditSlot} />)}</div>
//             <button
