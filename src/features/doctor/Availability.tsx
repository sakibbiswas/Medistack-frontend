...
const Availability: React.FC<Props> = ({ doctorId }) => {
  ...
  if (!doctorId) {
    return (
      <div className="flex">
        <Sidebar />
        <div className="flex-1 ml-0 lg:ml-64 p-6 text-red-600 mt-6 font-bold">
          Go back to Dashboard.
        </div>
      </div>
    );
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <main className="flex-1 ml-0 lg:ml-64 p-6">
        ...
        <div className="bg-white shadow rounded-lg p-4 sm:p-6">
          ...
          <button
            onClick={handleSave}
            className="mt-4 px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 transition w-full sm:w-auto"
          >
            Save Changes
          </button>
        </div>
